  ...
  return (
    <main className="min-h-screen bg-slate-100 p-3 sm:p-4 lg:p-6">
      <div className="mx-auto grid h-full w-full max-w-6xl overflow-hidden rounded-2xl bg-white shadow-xl lg:grid-cols-2">
        ...
        <section className="flex h-full items-start justify-center overflow-y-auto p-4 sm:p-6 lg:items-center lg:p-8">
          <div className="w-full max-w-md py-2">
            <h2 className="text-2xl font-bold text-slate-900 sm:text-3xl">Create your account</h2>
            <p className="mt-1 text-sm text-slate-700">Fill in your details to get started.</p>
